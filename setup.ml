...
(* OASIS_START *)
(* DO NOT EDIT (digest: 20bf3c99dfe948e9dc6c80025bfbaafe) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/bennn/assertions.git";
          synopsis = "A few basic assert statements";
          description = None;
          categories = [];
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Serializer"; "Assertions"];
                      lib_pack = false;
     ...
     oasis_version = "0.4.5";
     oasis_digest =
       Some "z\138\203\003\150\1360;\245\149\200\225\133C\004\129";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
