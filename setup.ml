...
(* OASIS_START *)
(* DO NOT EDIT (digest: 24ef0766379164b2cf14eab9c7382665) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          synopsis = "Simple assert statements for OCaml";
          description = None;
          categories = [];
     ...
     oasis_version = "0.4.1";
     oasis_digest = Some "hð]ØÖyboF4B¼7\158À¢";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
